...
pub unsafe fn resolve_modrm32_(modrm_byte: i32) -> OrPageFault<i32> {
    ...
    Ok(if r as i32 == 4 {
        if modrm_byte < 64 {
            ...
            resolve_sib(true)?.wrapping_add(if modrm_byte < 128 {
                read_imm8s()?
            } else {
                read_imm32s()?
            })
        ...
        if modrm_byte < 64 {
            ...
            get_seg_prefix_ss(read_reg32(EBP).wrapping_add(if modrm_byte < 128 {
                read_imm8s()?
            } else {
                read_imm32s()?
            }))?
        ...
        get_seg_prefix_ds(read_reg32(r as i32).wrapping_add(if modrm_byte < 128 {
            read_imm8s()?
        } else {
            read_imm32s()?
        }))?
...
unsafe fn resolve_sib(with_imm: bool) -> OrPageFault<i32> {
    ...
    Ok(get_seg_prefix(seg)?.wrapping_add(base).wrapping_add(offset))
}

pub unsafe fn resolve_modrm32(modrm_byte: i32) -> OrPageFault<i32> {
    match modrm_byte & !0o070 {
        0o000 => get_seg_prefix_ds(read_reg32(EAX)),
        0o100 => get_seg_prefix_ds(read_reg32(EAX).wrapping_add(read_imm8s()?)),
        0o200 => get_seg_prefix_ds(read_reg32(EAX).wrapping_add(read_imm32s()?)),
        0o001 => get_seg_prefix_ds(read_reg32(ECX)),
        0o101 => get_seg_prefix_ds(read_reg32(ECX).wrapping_add(read_imm8s()?)),
        0o201 => get_seg_prefix_ds(read_reg32(ECX).wrapping_add(read_imm32s()?)),
        0o002 => get_seg_prefix_ds(read_reg32(EDX)),
        0o102 => get_seg_prefix_ds(read_reg32(EDX).wrapping_add(read_imm8s()?)),
        0o202 => get_seg_prefix_ds(read_reg32(EDX).wrapping_add(read_imm32s()?)),
        0o003 => get_seg_prefix_ds(read_reg32(EBX)),
        0o103 => get_seg_prefix_ds(read_reg32(EBX).wrapping_add(read_imm8s()?)),
        0o203 => get_seg_prefix_ds(read_reg32(EBX).wrapping_add(read_imm32s()?)),
        0o004 => resolve_sib(false),
        0o104 => Ok(resolve_sib(true)?.wrapping_add(read_imm8s()?)),
        0o204 => Ok(resolve_sib(true)?.wrapping_add(read_imm32s()?)),
        0o005 => get_seg_prefix_ds(read_imm32s()?),
        0o105 => get_seg_prefix_ss(read_reg32(EBP).wrapping_add(read_imm8s()?)),
        0o205 => get_seg_prefix_ss(read_reg32(EBP).wrapping_add(read_imm32s()?)),
        0o006 => get_seg_prefix_ds(read_reg32(ESI)),
        0o106 => get_seg_prefix_ds(read_reg32(ESI).wrapping_add(read_imm8s()?)),
        0o206 => get_seg_prefix_ds(read_reg32(ESI).wrapping_add(read_imm32s()?)),
        0o007 => get_seg_prefix_ds(read_reg32(EDI)),
        0o107 => get_seg_prefix_ds(read_reg32(EDI).wrapping_add(read_imm8s()?)),
        0o207 => get_seg_prefix_ds(read_reg32(EDI).wrapping_add(read_imm32s()?)),
        _ => {
            dbg_assert!(false);
            std::hint::unreachable_unchecked()
        }
