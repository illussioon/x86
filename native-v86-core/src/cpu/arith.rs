...
fn opsize_to_mask(op_size: i32) -> i32 {
    ...
    (2i32.wrapping_shl(op_size as u32)).wrapping_sub(1)
}

unsafe fn add(dest_operand: i32, source_operand: i32, op_size: i32) -> i32 {
    let res = dest_operand.wrapping_add(source_operand) & opsize_to_mask(op_size);
...
unsafe fn adc(dest_operand: i32, source_operand: i32, op_size: i32) -> i32 {
    let cf = getcf() as i32;
    let res = dest_operand.wrapping_add(source_operand).wrapping_add(cf) & opsize_to_mask(op_size);
    *last_op1 = dest_operand;
    *last_result = res;
    *last_op_size = op_size;
...
unsafe fn sub(dest_operand: i32, source_operand: i32, op_size: i32) -> i32 {
    let res = dest_operand.wrapping_sub(source_operand) & opsize_to_mask(op_size);
    *last_op1 = dest_operand;
    *last_result = res;
    *last_op_size = op_size;
...
unsafe fn sbb(dest_operand: i32, source_operand: i32, op_size: i32) -> i32 {
    let cf = getcf() as i32;
    let res = dest_operand.wrapping_sub(source_operand).wrapping_sub(cf) & opsize_to_mask(op_size);
    *last_op1 = dest_operand;
    *last_result = res;
    *last_op_size = op_size;
...
pub unsafe fn add32(x: i32, y: i32) -> i32 {
    return add(x, y, OPSIZE_32);
}
pub unsafe fn sub8(x: i32, y: i32) -> i32 {
    return sub(x, y, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn sub16(x: i32, y: i32) -> i32 {
    return sub(x, y, OPSIZE_16);
}
pub unsafe fn sub32(x: i32, y: i32) -> i32 {
    return sub(x, y, OPSIZE_32);
}
#[no_mangle]
pub unsafe fn adc8(x: i32, y: i32) -> i32 {
    return adc(x, y, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn adc16(x: i32, y: i32) -> i32 {
    return adc(x, y, OPSIZE_16);
}
pub unsafe fn adc32(x: i32, y: i32) -> i32 {
    return adc(x, y, OPSIZE_32);
}
#[no_mangle]
pub unsafe fn sbb8(x: i32, y: i32) -> i32 {
    return sbb(x, y, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn sbb16(x: i32, y: i32) -> i32 {
    return sbb(x, y, OPSIZE_16);
}
pub unsafe fn sbb32(x: i32, y: i32) -> i32 {
    return sbb(x, y, OPSIZE_32);
}
...
pub unsafe fn cmp32(x: i32, y: i32) {
    sub(x, y, OPSIZE_32);
}
...
#[no_mangle]
pub unsafe fn inc8(x: i32) -> i32 {
    return inc(x, OPSIZE_8);
}
pub unsafe fn inc16(x: i32) -> i32 {
    return inc(x, OPSIZE_16);
}
pub unsafe fn inc32(x: i32) -> i32 {
    return inc(x, OPSIZE_32);
}
#[no_mangle]
pub unsafe fn dec8(x: i32) -> i32 {
    return dec(x, OPSIZE_8);
}
pub unsafe fn dec16(x: i32) -> i32 {
    return dec(x, OPSIZE_16);
}
pub unsafe fn dec32(x: i32) -> i32 {
    return dec(x, OPSIZE_32);
}

unsafe fn neg(dest_operand: i32, op_size: i32) -> i32 {
    sub(0, dest_operand, op_size)
}
#[no_mangle]
pub unsafe fn not8(x: i32) -> i32 {
    return !x;
}
#[no_mangle]
pub unsafe fn neg8(x: i32) -> i32 {
    return neg(x, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn neg16(x: i32) -> i32 {
    return neg(x, OPSIZE_16);
}
pub unsafe fn neg32(x: i32) -> i32 {
    return neg(x, OPSIZE_32);
}
...
pub unsafe fn and8(x: i32, y: i32) -> i32 {
    return and(x, y, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn and16(x: i32, y: i32) -> i32 {
    return and(x, y, OPSIZE_16);
}
pub unsafe fn and32(x: i32, y: i32) -> i32 {
    return and(x, y, OPSIZE_32);
}
pub unsafe fn test8(x: i32, y: i32) {
    and(x, y, OPSIZE_8);
}
pub unsafe fn test16(x: i32, y: i32) {
    and(x, y, OPSIZE_16);
}
pub unsafe fn test32(x: i32, y: i32) {
    and(x, y, OPSIZE_32);
}
pub unsafe fn or8(x: i32, y: i32) -> i32 {
    return or(x, y, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn or16(x: i32, y: i32) -> i32 {
    return or(x, y, OPSIZE_16);
}
pub unsafe fn or32(x: i32, y: i32) -> i32 {
    return or(x, y, OPSIZE_32);
}
pub unsafe fn xor8(x: i32, y: i32) -> i32 {
    return xor(x, y, OPSIZE_8);
}
#[no_mangle]
pub unsafe fn xor16(x: i32, y: i32) -> i32 {
    return xor(x, y, OPSIZE_16);
}
pub unsafe fn xor32(x: i32, y: i32) -> i32 {
    return xor(x, y, OPSIZE_32);
}
...
pub unsafe fn bsf16(old: i32, bit_base: i32) -> i32 {
    ...
    *last_op_size = OPSIZE_16;
    if bit_base == 0 {
        ...
        *flags &= !FLAG_ZERO;
        *last_result = int_log2(bit_base.wrapping_neg() & bit_base);
        return *last_result;
    };
}
#[no_mangle]
